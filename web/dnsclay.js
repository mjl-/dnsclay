...
(function (api) {
	...
	api.parser = {
		...
		Provider_mijnhost: (v) => api.parse("Provider_mijnhost", v),
		...
		Provider_westcn: (v) => api.parse("Provider_westcn", v),
